...
include("build_dc_opf.jl") # Define build_ac_opf! function
build_dc_opf!(m) # Pass the model to the build_ac_opf! function
...
result_pm = PowerModels.solve_opf(case_file, DCPPowerModel, gurobi) # Solve using PowerModels and retrieve the solutions
